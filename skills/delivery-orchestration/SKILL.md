...
bundle, output, generation,
and mutation epoch. Completion requires that exact receipt and complete finding
dispositions. Accepted findings advance the generation and require refreeze plus
