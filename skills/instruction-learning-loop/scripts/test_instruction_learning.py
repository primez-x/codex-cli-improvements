...
class HookTests(unittest.TestCase):
    ...
    def test_event_key_and_detection_corpus(self):
        ...
        self.assertIn("global risk trigger", context.lower())
        self.assertIn("focused root verification", context.lower())
...
class AuditTests(unittest.TestCase):
    ...
    def test_audit_accepts_links_between_sibling_authoritative_skills(self):
        ...
        if qv_src.is_file():
            ...
            # This link-resolution test needs a validator fixture, not a bundled system skill.
    ...
    def test_audit_nested_agents_and_duplicate_leads(self):
        ...
        self.assertFalse(any(any(token in p for token in ("/sites/", "/.local-scratch/", "/dist/", "/snapshots/")) for p in normalized))
